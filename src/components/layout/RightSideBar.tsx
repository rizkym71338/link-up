...
export const RightSideBar = async (props: RightSideBarProps) => {
  ...
  return (
    <section className="custom-scrollbar sticky right-0 top-0 z-10 h-screen w-full max-w-[300px] overflow-auto border-l border-dark-2 bg-purple-2 p-4 max-lg:hidden">
